...
export const companies = {
  electronics: {
    ...
    products: [
      ...
      { name: "X-Ray Inspection System", category: "Security", price: "Talk to our team", image: "/assets/products/electronics/x-ray-inspection-system.png", details: ["Advanced screening for security and inspection operations", "Accurate detection", "Operator-friendly controls", "Reliable performance"] },
      { name: "Electric Fence Solutions", category: "Security", price: "Talk to our team", image: "/assets/products/electronics/electric-fence-solutions.png", details: ["Perimeter protection for homes, farms, and businesses", "Easy installation", "Durable, weather-resistant components", "Safe and secure operation"] },
      { name: "Electric Fence Accessories", category: "Security", price: "Talk to our team", image: "/assets/products/electronics/electric-fence-accessories.png", details: ["Aluminum-alloy and stainless-steel wire", "Insulators", "Warning signs", "Mounting and grounding hardware"] },
      { name: "Electric Fence Installation", category: "Security", price: "Talk to our team", image: "/assets/products/electronics/electric-fence-installation.png", details: ["Tailored system design", "Quality energizers and durable components", "Professional installation", "Solutions for homes, farms, and businesses"] },
